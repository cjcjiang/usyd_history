...
/**
 * The chain driver chains task 1’s job and task 2’s job 
 * so that we can get the result of task 1 to implement task 2.
 */
...
public class TaskTwoChainDriver {
	public static void main(String[] args) throws Exception {
		...
		taskOneJob.setCombinerClass(TaskOneReducer.class);
