...
/**
 * 
 * This TaskThreePartThreeComparator is designed to sort all of the records by the order:
 * 
 * Descending with numberOfPhotos 
 * Descending with freq of each tag
 * 
...
public class TaskThreePartThreeComparator extends WritableComparator {
	...
	public int compare(WritableComparable w1, WritableComparable w2) {
		...
		int result = -1 * numOfPhotos1.compareTo(numOfPhotos2);
		if(0 == result) {
